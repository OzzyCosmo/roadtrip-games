  ...
  <div class="justify-center items-center flex flex-col mt-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 mt-4">
        <a href="/games/service-station-locator">
          <div class="bg-[url('/storage/petrol-station.jpg')] bg-contain border-2 rounded-2xl h-40 w-80 drop-shadow-2xl flex justify-center items-center font-bold text-2xl text-center text-red-600"><span class="drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]"">Service Station <br> Locator </span></div>
        </a>
